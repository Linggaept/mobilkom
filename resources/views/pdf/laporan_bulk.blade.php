...
<head>
    ...
    <style>
        * { font-family: 'DejaVu Sans', Arial, sans-serif; font-size: 11px; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer { margin-top: 15px; border-top: 1px solid #ddd; padding-top: 8px; text-align: center; font-size: 9px; color: #888; }
...
<body>
    @foreach($laporanList as $i => $laporan)
        <div class="{{ $i < $laporanList->count() - 1 ? 'page-break' : '' }}">
